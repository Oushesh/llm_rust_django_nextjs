#Reference: https://github.com/onlyphantom/llm-python/blob/main/09_pinecone.py
...
##To change for inferencing with local models
...
## Get the pinecone working, switch with supabase
## Get the code working with Go and the model inference (test the other things:
##